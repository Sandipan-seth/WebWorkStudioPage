...
const Card = ({ color, heading,description }) => {
  return (
    <div
      className="w-full md:w-1/3 h-fit p-6 rounded-2xl  shadow-[10px_10px_8px_rgba(0,0,0,0.7)] transition-transform duration-300 hover:scale-105 border-2 border-black"
